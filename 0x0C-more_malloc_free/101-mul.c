...
void *mul_array(char *a1, int num1, char a2, char *a3, int lena)
{
	int mul = 0, i, k;
...
int main(int argc, char *argv[])
{
	...
	for (i = num2 - 1, c = 0; i >= 0; i--)
	{
	tabres = mul_array(argv[1], num1, argv[2][i], tabres, (lenres - 1 - c));
	c++;
	}
